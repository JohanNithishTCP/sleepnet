                        ...
                        <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row gap-6 md:gap-8">
                            <div className="flex flex-1 gap-4 items-start xl:items-start group cursor-pointer hover:-translate-y-1 transition-transform">
                                ...
                                <div className="pt-0.5 flex-1">
                                    <h3 className="text-brand-blue font-bold text-sm sm:text-[15px] md:text-base mb-1 md:mb-1.5 transition-colors group-hover:text-brand-cyan">Explore Sleepnet</h3>
                            ...
                            <div className="flex flex-1 gap-4 items-start xl:items-start group cursor-pointer hover:-translate-y-1 transition-transform">
                                ...
                                <div className="pt-0.5 flex-1">
                                    <h3 className="text-brand-blue font-bold text-sm sm:text-[15px] md:text-base mb-1 md:mb-1.5 transition-colors group-hover:text-brand-cyan">Careers</h3>
                                    <p className="text-gray-500 text-xs sm:text-sm leading-relaxed pr-2 sm:pr-4">
